...
def detect_card_edges_with_sides(
    image_path: str, a=True, b=True
    ...
    img_thresh = cv2.adaptiveThreshold(
        img_blur, 255, cv2.ADAPTIVE_THRESH_MEAN_C, cv2.THRESH_BINARY_INV, 5, thresh_c
    )
