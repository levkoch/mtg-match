% adapted from the spring 2025 uw cse 446 class (taught by Natasha Jaques)
...
\providecommand*{\dv}[1]{\frac{\diff}{\diff{#1}}}
...
\newcounter{bprob}
\newenvironment{bprob}[1][]{\refstepcounter{bprob}\par\medskip\noindent B\thebprob.#1 }
